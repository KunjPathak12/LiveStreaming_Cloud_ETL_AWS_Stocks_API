...
userTickerPath = f"silverLayer/{ticker}TickerTransform/"
...
bucket_name = 'finstocktickers'
allTickersFilePath = f'goldenLayer/{ticker}FinStockData'
FinalData.write.mode("overwrite").parquet(f"s3://{bucket_name}/{allTickersFilePath}")
print(f"file writen to: s3://{bucket_name}/{allTickersFilePath}")
